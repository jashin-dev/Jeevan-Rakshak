function Card({ re }) {
  ...
  return (
    <div className="p-8 max-lg:p-4 rounded-md w-[30%] border-2 text-gray-500 flex flex-col hover:shadow-md hover:scale-[.98] transition-all duration-300 shadow-lg overflow-x-hidden review" >
